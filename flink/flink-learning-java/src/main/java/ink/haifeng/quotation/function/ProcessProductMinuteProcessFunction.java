...
//
//public class ProcessProductMinuteProcessFunction extends KeyedBroadcastProcessFunction<String, StockDataWithPre, List<ProductConstituentsInfo>, ProductData> {
//
///*
...
//
//    @Override
//    public void processElement(StockDataWithPre stockData,
//                               KeyedBroadcastProcessFunction<String, StockDataWithPre, List<ProductConstituentsInfo>, ProductData>.ReadOnlyContext readOnlyContext,
...
//
//    @Override
//    public void processBroadcastElement(List<ProductConstituentsInfo> infos, KeyedBroadcastProcessFunction<String, StockDataWithPre, List<ProductConstituentsInfo>, ProductData>.Context context, Collector<ProductData> collector) throws Exception {
